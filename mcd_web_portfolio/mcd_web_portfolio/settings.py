"""
Django settings for mcd_web_portfolio project.
...
ALLOWED_HOSTS = ['0.0.0.0', 'localhost', '127.0.0.1', 'mcd-web-portfolio.herokuapp.com']
...
ROOT_URLCONF = 'mcd_web_portfolio.urls'
...
WSGI_APPLICATION = 'mcd_web_portfolio.wsgi.application'
...
STATIC_URL = 'mysite/static/mysite/'
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, 'mysite/static/mysite'),
)
